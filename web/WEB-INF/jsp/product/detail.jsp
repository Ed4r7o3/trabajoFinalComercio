<%-- 
    Document   : detail
    Created on : 01-ago-2017, 10:04:23
    Author     : Edd
--%>
...
<!-- cart -->
  <script defer src="${pageContext.servletContext.contextPath}/assets/js/jquery.flexslider.js"></script>
<link rel="stylesheet" href="${pageContext.servletContext.contextPath}/assets/css/flexslider.css" type="text/css" media="screen" />
<script src="${pageContext.servletContext.contextPath}/assets/js/imagezoom.js"></script>
<script>
...
<script src="${pageContext.servletContext.contextPath}/assets/js/owl.carousel.js"></script>
	<script>
        ...
        <div class="single-wl3">
            <div class="container">
                        ...
                        <div clas="single-top">
                            <div class="single-left">
                                <div class="flexslider">
                                    <ul class="slides">
                                        <li data-thumb="${pageContext.servletContext.contextPath}/assets/images/${product.photo}">
                                            <div class="thumb-image"> <img src="${pageContext.servletContext.contextPath}/assets/images/${product.photo}" data-imagezoom="true" class="img-responsive"> </div>
                                        </li>
                                        <li data-thumb="${pageContext.servletContext.contextPath}/assets/images/${product.photo2}">
                                            <div class="thumb-image"> <img src="${pageContext.servletContext.contextPath}/assets/images/${product.photo2}" data-imagezoom="true" class="img-responsive"> </div>
                                        </li>
                                        <li data-thumb="${pageContext.servletContext.contextPath}/assets/images/${product.photo}">
                                            <div class="thumb-image"> <img src="${pageContext.servletContext.contextPath}/assets/images/${product.photo}" data-imagezoom="true" class="img-responsive"> </div>
                                        </li> 
                            ...
                            <div class="single-right simpleCart_shelfItem">
                                ...
                                <p class="price item_price">s/.${product.price}</p>
                                <div class="description">
                                    <p><span>Vista Rapida : </span>${product.description} </p>
                                </div>
                ...
                <div class="product-w3agile">
                    <h3 class="tittle1">Descripcion del producto</h3>
                        ...
                        <div class="col-md-4 product-grid">
                            <div id="owl-demo" class="owl-carousel">
                                ...
                                <div class="item">
                                    <div class="recent-grids">
                                        <div class="recent-left">
                                            <a href="single.html"><img class="img-responsive " src="${pageContext.servletContext.contextPath}/assets/images/r4.jpg" alt=""></a>	
                                        </div>
                                        <div class="recent-right">
                                            <h6 class="best2"><a href="single.html">Lorem ipsum dolor </a></h6>
                                            <div class="block">
                                    ...
                                    <div class="recent-grids">
                                        <div class="recent-left">
                                            <a href="single.html"><img class="img-responsive " src="${pageContext.servletContext.contextPath}/assets/images/r5.jpg" alt=""></a>	
                                        </div>
                                        <div class="recent-right">
                                            <h6 class="best2"><a href="single.html">Duis aute irure </a></h6>
                                            <div class="block">
                            ...
                            <img class="img-responsive " src="${pageContext.servletContext.contextPath}/assets/images/woo2.jpg" alt="">
                        </div>
                                            ...
                                            <div class="descr">
                                                <div class="reviews-top">
                                                    <div class="reviews-left">
                                                        <img src="${pageContext.servletContext.contextPath}/assets/images/men3.jpg" alt=" " class="img-responsive">
                                                    </div>
                        ...
                        <div class="grid-arr">
                            <div  class="grid-arrival">
                                <figure>		
                                    <a href="single.html">
                                        <div class="grid-img">
                                            <img  src="${pageContext.servletContext.contextPath}/assets/images/p28.jpg" class="img-responsive" alt="">
                                        </div>
                                        <div class="grid-img">
                                            <img  src="${pageContext.servletContext.contextPath}/assets/images/p27.jpg" class="img-responsive"  alt="">
                                        </div>			
                                    </a>		
                                </figure>	
                            </div>
